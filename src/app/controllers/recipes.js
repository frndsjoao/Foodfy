...
exports.post = async function(req, res) {
    ...
    try {
        ...
        let { recipes, pagination, files } = await loadPaginateService.load('Recipes', 1, 6)
...
exports.put = async function(req, res) {
    let { recipes, files, pagination } = await loadPaginateService.load('Recipes', 1, 6)
    try {
        let filesIds
...
exports.delete = async function(req, res) {
    ...
    try {
        ...
        let { recipes, files: recipesFiles, pagination } = await loadPaginateService.load('Recipes', 1, 6)
        return res.render("admin/recipes/index", {
            recipes,
            files: recipesFiles,
            pagination,
